...
# set the stage
	...
	try(
        {
            print(s.new)
            pdf(file=paste(arraydata, "pluritest_image02.pdf",sep="_"))
            par(mar=c(12,4,4,2))
            par(xaxt='n')
	...
	try(
        {
            pdf(file=paste(arraydata, "pluritest_image03.pdf",sep="_"))
	...
	try(
        ...
        pdf(file=paste(arraydata, "pluritest_image03c.pdf",sep="_"))
        par(mar=c(12,4,4,2))
        par(xaxt='n')
